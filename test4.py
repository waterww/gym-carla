...
'''add records for epsilon and action choice'''
...
class MyModel(tf.keras.Model):
    ...
    def call(self, inputs):
        ...
        # the output of NN is Q value
        # find the max of Q value, the index represents index of action
        return output
...
def play_game(env, TrainNet, TargetNet, epsilon, copy_step):
    ...
    return rewards, np.mean(losses), selected_actions
...
def make_video2(env, TrainNet, n):
    ...
    # client.start_recorder("/data/leuven/350/vsc35061/lib1/gym-carla/video/carla_recording_%d.log" % n)
...
def main():
    ...
    for n in range(N):
        ...
        total_reward, loss, selected_actions = play_game(env, TrainNet, TargetNet, epsilon, copy_step)        
